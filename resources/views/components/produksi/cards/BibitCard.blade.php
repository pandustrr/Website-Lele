<div id="bibit-card" class="bg-white rounded-lg shadow p-3 hover:shadow-md transition-all duration-300 border border-gray-100">
    ...
    <form action="{{ route('bibit.store') }}" method="POST">
        ...
        <div class="space-y-2">
            ...
            <div class="pt-1">
                <button type="submit" class="w-full bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold py-2 rounded-md">
                    Simpan Bibit
                </button>
            </div>
        </div>
