<div id="pakan-card" class="bg-white rounded-lg shadow p-3 hover:shadow-md transition-all duration-300 border border-gray-100">
    ...
    <form action="{{ route('pakan.store') }}" method="POST">
        ...
        <div class="space-y-2">
            ...
            <div class="pt-1">
                <button type="submit" class="w-full bg-green-500 hover:bg-green-600 text-white text-sm font-semibold py-2 rounded-md">
                    Simpan Pakan
                </button>
            </div>
        </div>
