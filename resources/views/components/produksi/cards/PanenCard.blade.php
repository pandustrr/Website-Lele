<div id="panen-card" class="bg-white rounded-lg shadow p-3 hover:shadow-md transition-all duration-300 border border-gray-100 flex flex-col h-full">
    <!-- Header -->
    ...
    <form action="{{ route('panen.store') }}" method="POST" class="flex flex-col flex-grow">
        ...
        <div class="pt-4">
            <button type="submit" class="w-full bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold py-2 rounded-md transition-colors duration-300">
                Simpan Panen
            </button>
        </div>
    </form>
